...
public class CallScreenActivity extends BaseActivity {
    ...
    private ImageView imageViewCalleImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageViewCalleImage = (ImageView) findViewById(R.id.imageViewCalleImage);
        ...
        Picasso.with(getApplicationContext()).load(imageUrl).into(imageViewCalleImage);
    ...
    private void updateUI() {
        ...
        if (call != null) {
            ...
            if (call.getState() == CallState.ESTABLISHED) {
                imageViewCalleImage.setVisibility(View.GONE);
                addVideoViews();
            }
        }
    }
